...
BIN_EXTENSIONS = ['.dll', '.pdb', '.config', '.exe', '.json', '.txt']
# Release.DeleteFiles.txt is patch-only metadata generated by MakeInstaller
# (lists files to remove during a patch apply); it doesn't belong in a major.
BIN_EXCLUDE = ['SDNativeTests.exe', 'SDNativeTests.pdb', 'SDNative.pdb',
               'Release.DeleteFiles.txt']
